...
export type RecentReservationFilterTypes = {
  search: string;
  sortBy: string;
  sortOrder: string;
};
...
type RecentReservationsFiltersProps = {
  filters: Partial<RecentReservationFilterTypes>;
  onChange: (filters: Partial<RecentReservationFilterTypes>) => void;
};

export function RecentReservationsFilters({
  filters,
  onChange,
}: RecentReservationsFiltersProps) {
